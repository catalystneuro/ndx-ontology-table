...
# -*- coding: utf-8 -*-
#
# ndx-ontology-table documentation build configuration file, created by
# sphinx-quickstart on Tue Apr 21 10:42:48 2020.
#
...
htmlhelp_basename = 'ndx-ontology-tabledoc'
...
latex_documents = [
    (master_doc, 'ndx-ontology-table.tex', 'ndx-ontology-table Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-ontology-table', 'ndx-ontology-table Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-ontology-table', 'ndx-ontology-table Documentation',
     author, 'ndx-ontology-table', 'One line description of project.',
     'Miscellaneous'),
]
